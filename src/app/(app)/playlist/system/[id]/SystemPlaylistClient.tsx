...
export function SystemPlaylistLoadingState() {
  return (
...
export default function SystemPlaylistClient({ id }: { id: string }) {
  ...
  // System playlists cannot be deleted or edited
  ...
  if (loading) {
    return <SystemPlaylistLoadingState />;
  }
  ...
  return (
    <div className={styles.page}>
      <button className={styles.backBtn} onClick={() => back("/home")} aria-label="Go back">
