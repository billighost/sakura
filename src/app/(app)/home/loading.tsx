  ...
  return (
    <div style={{ padding: "clamp(0.75rem, 3vw, 1.25rem)" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem" }}>
        <div style={{ width: "6rem", height: "1.5rem", borderRadius: "6px", background: "var(--sakura-skeleton)" }} />
        <div style={{ width: "2.25rem", height: "2.25rem", borderRadius: "50%", background: "var(--sakura-skeleton)" }} />
      </div>
